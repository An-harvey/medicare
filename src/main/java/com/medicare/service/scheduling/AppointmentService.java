...
public interface AppointmentService {
    ...
    void staffupdateAppointmentStatus(UUID appointmentId, AppointmentStatus status);
    ...
    AppointmentResponseDTO doctorUpdateAppointmentStatus(UUID appointmentId, AppointmentStatus status);

    //Staff lấy danh sách các patien đặt ở trangj thái pending
    List<AppointmentResponseDTO> getPendingAppointmentsForStaff();
}

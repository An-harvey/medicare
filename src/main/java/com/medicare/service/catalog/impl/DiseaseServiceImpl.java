...
import com.medicare.repository.RecordDiseaseRepository;
...
public class DiseaseServiceImpl implements DiseaseService {
    ...
    public void deleteDisease(Integer id) {
        ...
        // Kiểm tra bệnh lý đã được sử dụng trong Bệnh án chưa
        if (recordDiseaseRepository.existsByDisease_Id(id)) {
            throw new CustomException("Không thể xóa: Bệnh lý này đã được ghi nhận trong hồ sơ bệnh án của bệnh nhân.", HttpStatus.BAD_REQUEST);
        }
